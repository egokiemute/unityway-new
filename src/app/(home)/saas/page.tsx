...
export default function page() {
  return (
    <div className="px-3 sm:px-4 lg:px-5 py-10 mx-auto">
      <Hero
        badgeHighlight="New"
        badgeText="Entitlements Billing Feature"
        heading="Build once, bill forever – automate your SaaS pricing infrastructure."
        subtext="Whether you're launching a new SaaS product or scaling to enterprise, ClearPrice gives you the infrastructure to define, test, and manage pricing without touching your backend."
        primaryCta={{
          label: "Book a Demo",
          href: "/pricing",
        }}
      ...
      />
      <Heading
        className="items-center text-center justify-center mx-auto text-3xl font-medium font-twk max-w-4xl pb-0"
        text="Everything you need to test pricing models, support any sales motion, and scale without billing chaos."
      />
      <FeatureSection
