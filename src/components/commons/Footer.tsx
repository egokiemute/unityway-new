...
function Footer() {
  return (
    <footer className="hero-sectio p-4 pt-28 md:pt-32 bg-[#0E152B]">
      <div className="px-2 flex flex-col md:flex-row gap-6 items-start justify-between border-b-[1px] border-[#413F3F] pb-20">
        ...
        <div className="max-w-sm flex flex-col gap-12 items-start text-start">
          <Logo type="secondary" />
          <p className="text-white text-[20px] leading-[130%] tracking-[-2%] font-bradford-light mt-0">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          {quickLinks.map((section) => (
            <div key={section.title} className="flex flex-col">
              <h4 className="text-[#D6C7A8] text-[16px] font-twk mb-5">
                {section.title}
              </h4>
      ...
      <div className="px-2 py-12 flex flex-col gap-6 md:flex-row justify-between">
        <p className="text-[14px] text-white leading-[160%] tracking-[-2%] font-twk">
          Copyright &copy; 2025 Unity Way Company Limited. All rights
          reserved.
        </p>
        <Link
          className="text-[14px] text-white leading-[160%] tracking-[-2%] font-twk font-thin"
          href="/contact"
        >
          Monday - Sunday
        </Link>
